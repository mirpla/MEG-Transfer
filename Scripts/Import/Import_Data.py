...
from Scripts.Import.Import_Preproc import MEG_import_process, MEG_extract_destination, MakeBoundaryElementModel, check_path, save_file_to_path
...
def Import_Data(sub_codes):
    ...
    base_path  = script_dir.parent.parent.parent # Basepath that is convenient to move from throughout the tree
