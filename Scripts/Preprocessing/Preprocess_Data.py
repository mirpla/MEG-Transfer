...
import Scripts.Preprocessing.Preproc_Functions
from Scripts.Preprocessing.Preproc_Functions import block_annotate, extract_sort_key, read_events
        ...
        for ses in ses_folders:
            ...
            if os.path.isdir(ses_path):
                ...
                for fif_file in fif_files_sorted:
                    ...
                    downsampled_file = downsampled_dir / fif_file.name.replace('_meg_tsss.fif', f'_meg_tsss_ds-{param_res_Fs}Hz.fif')
